...
namespace SerialPortTerminal
{
  ...
  public partial class frmTerminal : Form
  {
    ...
    public frmTerminal()
    {
      ...
      txtDuration.Text = timer.Interval.ToString();
      txtTimes.Text = "0";
    ...
    private void EnableControls()
    {
      ...
      btnStart.Enabled = comport.IsOpen;
    ...
    private void btnStart_Click(object sender, EventArgs e)
    {
        if (btnStart.Text == "START")
        {
            ...
            {
                timer.Interval = Convert.ToInt32(txtDuration.Text);
            }
            if (txtTimes.Text != null && txtTimes.Text != "")
            {
                PollNumber = Convert.ToInt32(txtTimes.Text.ToString());
            }
            for (int i = 10; i > 0; i--)
            {
